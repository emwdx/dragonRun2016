...
Router.onBeforeAction(requireLogin, {except:['registrationNotReady', ,'frontPage','aboutPage','registerAccount','privacy','terms-of-use','signIn','atForgotPwd', 'forgotPwd', 'resetPwd','raceResults','signInAccount']});
